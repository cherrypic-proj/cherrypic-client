...
class PaymentBox extends StatelessWidget {
  ...
  /// 테두리 곡선 여부
  final bool isFlatStyle;
  /// startDate & endDate 표시 여부
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: isFlatStyle ? null : BorderRadius.circular(8),
        ),
        child: Column(
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  /// 구독 시작일 + 다음 결제일
                  if (showDates && badgeType != AlbumBadgeType.basic && model.nextDate != null) ...[
