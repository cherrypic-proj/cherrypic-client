        ...
        child: Column(
          ...
          children: [
            ...
            EnabledButton(
              ...
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Outlined 버튼 클릭됨')),
                );
              },
            ),
            const SizedBox(height: 16),
            PressedButton(
              ...
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Filled 버튼 클릭됨')),
                );
              },
            ),
            ...
            ExitAlbumButton(
              text: '앨범 나가기',
              // imageAsset: 'assets/images/door_open.png',
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('앨범 나가기 클릭됨')),
                );
              },
            ),
            ...
            UnSubscribeButton(
              text: '앨범 구독 해지',
              // imageAsset: 'assets/images/trash_icon.png',
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('앨범 구독 해지 클릭됨')),
                );
              },
            ),
          ],
