class RoutePath {
  ...
  static const String myPage_payment_info =
      '/my_page/album_payment_info/info/payment_info_screen';
  ...
  static const String select_album =
      '/store/photo_printing/service_step/select_album/select_album_screen';
  static const String select_image =
      '/store/photo_printing/service_step/select_image/select_image_screen';
  static const String select_option =
      '/store/photo_printing/service_step/select_option/select_option_screen';
  static const String select_address =
      '/store/photo_printing/service_step/select_address/select_address_screen';
  static const String change_address =
      '/store/photo_printing/service_step/change_address/change_address_screen';
  static const String select_payment =
      '/store/photo_printing/service_step/select_payment/select_payment_screen';
